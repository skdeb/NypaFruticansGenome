...
CONFIG_PATH="/scratch/skdeb/Nypa/masurca_assembly/Final_assembly/config.txt"
CMD_PATH="/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/masurca"
set -o pipefail
...
#}
export PATH="/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/../CA8/Linux-amd64/bin:/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin:$PATH"
save PATH
export PERL5LIB=/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/../lib/perl${PERL5LIB:+:$PERL5LIB}
save PERL5LIB
NUM_THREADS=32
save NUM_THREADS
...
rename_filter_fastq 'pe' <(exec expand_fastq '/grps2/mrmckain/Palms_Barrett/data/Nypa/mmckain/Nypa_R1.fastq.gz' | awk '{if(length($0>250)) print substr($0,1,250); else print $0;}') <(exec expand_fastq '/grps2/mrmckain/Palms_Barrett/data/Nypa/mmckain/Nypa_R2.fastq.gz' | awk '{if(length($0>250)) print substr($0,1,250); else print $0;}' ) > 'pe.renamed.fastq'
...
quorum_error_correct_reads  -q $(($MIN_Q_CHAR + 40)) --contaminant=/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/../share/adapter.jf -m 1 -s 1 -g 1 -a 3 -t 32 -w 10 -e 3 -M  quorum_mer_db.jf pe.renamed.fastq --no-discard -o pe.cor.tmp --verbose 1>quorum.err 2>&1 && mv pe.cor.tmp.fa pe.cor.fa || fail Error correction of PE reads failed. Check pe.cor.log.
...
rm -rf work1
CA_DIR="CA";
/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/createSuperReadsForDirectory.perl -doSimpleMerge -l $KMER -mean-and-stdev-by-prefix-file meanAndStdevByPrefix.pe.txt -kunitigsfile guillaumeKUnitigsAtLeast32bases_all.fasta -t 32 -mikedebug work1 pe.cor.fa 1> super1.err 2>&1
/mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/mega_reads_assemble_cluster2.sh  -k $KMER -F -E SGE -Pb 5000000000 -q all.q -G 0 -C 25 -t 32 -e $ESTIMATED_GENOME_SIZE -m work1 -a /mrm/bin/Masurca4.0.6/masurca-4.0.6/MaSuRCA-4.0.6/bin/../Flye/bin -o "   cgwErrorRate=0.15"  -B 15 -M 17 -D 0.02 -n /grps2/mrmckain/Nypa_Genome/nano_concatenated.fasta 
